...
#if defined(NDEBUG)
# error "Titanium cannot be compiled without assertions."
#endif
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    // yearly decline of production by ~0.99% per year, projected ~18M coins max by year 2050+.
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    LogPrint(BCLog::BENCHMARK, "    - Ttm specific: %.2fms [%.2fs]\n", 0.001 * (nTime5 - nTime4), nTimeTtmSpecific * 0.000001);
