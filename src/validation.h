 ...
 *  We have 4 times smaller block times in Ttm, so we need to push 4 times more invs per 1MB. */
...
static const int64_t DEFAULT_MAX_TIP_AGE = 20 * 24 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
